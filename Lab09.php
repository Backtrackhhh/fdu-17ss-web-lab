    ...
    <main class="container">
        ...
        <div class="btn-group countryButtons" role="group" aria-label="...">
              ...
              foreach($countries as $country=>$country_name){
                  echo '<a href="list.php?country='.$country_name.'" role="button" class="btn btn-default">'.$country_name.'</a>';
              }
		...
		<ul class="caption-style-2">
          ...
          echo '        <li>
                      <a href="detail.php?id='.$image_value["id"].'" class="img-responsive">
                          <img src="images/square/'.$image_value["path"].'" alt="'.$image_value['title'].'">
                          <div class="caption">
                              <div class="blur"></div>
                              <div class="caption-text">
                                  <h1>'.$image_value["title"].'</h1>
                              </div>
                          </div>
                      </a>
                  </li>';}
